...
def helpwindow():
    ...
    lab1 = Label(top, text="first player name will be player 0", font=("Ariel", 8, "bold")).pack(side=TOP, fill="x")
    lab1 = Label(top, text="Second player name will be player X", font=("Ariel", 8, "bold")).pack(side=TOP, fill="x")
